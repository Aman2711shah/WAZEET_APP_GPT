...
final List<Industry> availableIndustries = [
  ...
  Industry(
    ...
    name: 'Legal Services',
    icon: '⚖️',
    description: 'Law Firms, Legal Consulting, and Compliance',
  ),
  Industry(
    id: 'automotive',
    name: 'Automotive',
    icon: '🚗',
    description: 'Car Dealerships, Auto Services, and Parts',
  ),
  Industry(
    id: 'aviation',
    name: 'Aviation',
    icon: '✈️',
    description: 'Airlines, Airport Services, and Aviation Tech',
  ),
  Industry(
    id: 'maritime',
    name: 'Maritime & Shipping',
    icon: '⚓',
    description: 'Ports, Marine Services, and Shipping Lines',
  ),
  Industry(
    id: 'agriculture',
    name: 'Agriculture',
    icon: '🌾',
    description: 'Farming, Agritech, and Food Production',
  ),
  Industry(
    id: 'sports',
    name: 'Sports & Fitness',
    icon: '⚽',
    description: 'Gyms, Sports Facilities, and Fitness Services',
  ),
  Industry(
    id: 'entertainment',
    name: 'Entertainment',
    icon: '🎬',
    description: 'Events, Cinema, and Entertainment Venues',
  ),
  Industry(
    id: 'telecom',
    name: 'Telecommunications',
    icon: '📡',
    description: 'Telecom Services, Networks, and Mobile',
  ),
  Industry(
    id: 'insurance',
    name: 'Insurance',
    icon: '🛡️',
    description: 'Insurance Providers and Risk Management',
  ),
  Industry(
    id: 'fashion',
    name: 'Fashion & Beauty',
    icon: '👗',
    description: 'Fashion, Beauty, and Personal Care',
  ),
  Industry(
    id: 'jewelry',
    name: 'Jewelry & Luxury',
    icon: '💎',
    description: 'Jewelry, Watches, and Luxury Goods',
  ),
  Industry(
    id: 'construction',
    name: 'Construction',
    icon: '🏗️',
    description: 'Building, Engineering, and Infrastructure',
  ),
  Industry(
    id: 'architecture',
    name: 'Architecture & Design',
    icon: '📐',
    description: 'Architectural Design and Interior Design',
  ),
  Industry(
    id: 'security',
    name: 'Security Services',
    icon: '🔒',
    description: 'Security, Surveillance, and Protection Services',
  ),
  Industry(
    id: 'cleaning',
  ...
  Industry(
    ...
    icon: '👥',
    description: 'Recruitment, HR Consulting, and Staffing',
  ),
  Industry(
    id: 'printing',
    name: 'Printing & Publishing',
    icon: '📰',
    description: 'Printing, Publishing, and Graphic Design',
  ),
  Industry(
    id: 'photography',
    name: 'Photography & Video',
    icon: '📸',
    description: 'Photography, Videography, and Production',
  ),
  Industry(
    id: 'furniture',
    name: 'Furniture & Interiors',
    icon: '🪑',
    description: 'Furniture, Home Decor, and Interior Fitting',
  ),
  Industry(
    id: 'trading',
